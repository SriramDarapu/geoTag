...
export class MapComponent implements OnInit {
  ...
  private initMap() {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(function(position) {
        ...
        var centerControl = new that.CenterControl(centerControlDiv, that.map, location);

        // centerControlDiv.index = 1;
        that.map.controls[google.maps.ControlPosition.RIGHT_BOTTOM].push(centerControlDiv);
  ...
  CenterControl(controlDiv, map, location) {
      ...
      // controlText.style.lineHeight = '38px';https://png.icons8.com/hunt/nolan/64
      ...
      controlText.style.backgroundImage = 'url("https://png.icons8.com/target/color/96")';
